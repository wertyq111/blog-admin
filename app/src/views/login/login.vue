<template>
  <div :class="['login-wrapper', ['', 'login-form-right', 'login-form-left'][direction]]">
    <el-form
      ...
      <h4><a href="/"><img src="/index/images/logo1.png"  alt=""/></a></h4>
    ...
    <div class="login-copyright">Copyright © 2023 vwms.netsun.com. All rights reserved.</div>
    <!-- 多语言切换 -->
...
.login-wrapper {
  ...
  background-image: url("/index/images/bg1.jpg");
