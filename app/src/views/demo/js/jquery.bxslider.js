...
(function ($) {
    ...
    $.fn.bxSlider = function (options) {
        ...
        var appendControls = function () {
            slider.controls.next = $('<a class="bx-next icon iconfont icon-fa-right" href="">' + slider.settings.nextText + '</a>');
            slider.controls.prev = $('<a class="bx-prev icon iconfont icon-fa-left" href="">' + slider.settings.prevText + '</a>');
