    ...
    <el-card shadow="never">
      ...
      <ele-pro-table
        ...
        <template slot="toolbar">
          <el-button
            v-if="permission.includes('sys:companydept:add')"
            class="ele-btn-icon"
            icon="el-icon-plus"
            size="small"
            type="primary"
          ...
          <el-button
            v-if="permission.includes('sys:companydept:expand')"
            class="ele-btn-icon"
            size="small"
            @click="expandAll">展开全部
          </el-button>
          <el-button
            v-if="permission.includes('sys:companydept:collapse')"
            class="ele-btn-icon"
            size="small"
            @click="foldAll">折叠全部
          </el-button>
        ...
        <template slot="action" slot-scope="{row}">
          <el-link
            v-if="permission.includes('sys:companydept:addz')"
            :underline="false"
            icon="el-icon-plus"
            type="primary"
          ...
          <el-link
            v-if="permission.includes('sys:companydept:edit')"
            :underline="false"
            icon="el-icon-edit"
            type="primary"
          ...
          <el-popconfirm
            ...
            @confirm="remove(row)">
            <el-link
              v-if="permission.includes('sys:companydept:delete')"
              slot="reference"
              :underline="false"
              icon="el-icon-delete"
              type="danger">删除
...
export default {
  ...
  methods: {
    ...
    remove(row) {
      ...
      this.$http.post('/companydept/delete', {id: row.id}).then(res => {
        loading.close();
        if (res.data.code === 0) {
